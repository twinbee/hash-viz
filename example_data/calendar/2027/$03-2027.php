...
<title>March, 2027 Hash Events</title>
...
<?php
    ...
    $prev_link="$02-2027.php";
    $next_link="$04-2027.php";
    include 'php.php';
?>
</head>
<body>
<map name="Map" id="Map">
    <area shape="rect" coords="0,0,150,91" href="$02-2027.php" alt="Previous Month" />
    <!-- FIXED: Using coordinates 957,0,807,91 as requested for the Next Month button -->
    <area shape="rect" coords="957,0,807,91" href="$04-2027.php" alt="Next Month" />
</map>
<div class=container>
