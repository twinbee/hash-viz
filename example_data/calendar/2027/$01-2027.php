...
<title>January, 2027 Hash Events</title>
...
<?php
    ...
    $prev_link="../2026/$12-2026.php";
    $next_link="$02-2027.php";
    include 'php.php';
?>
</head>
<body>
<map name="Map" id="Map">
    <area shape="rect" coords="0,0,150,91" href="../2026/$12-2026.php" alt="Previous Month" />
    <!-- FIXED: Using coordinates 957,0,807,91 as requested for the Next Month button -->
    <area shape="rect" coords="957,0,807,91" href="$02-2027.php" alt="Next Month" />
</map>
<div class=container>
					...
					<tr>
						...
						<td class="day">
							<table class="inner" id="j018">
								<tr>
									<td class="holiday"><span class="tag">MLK Jr. Day</span>18</td>
								</tr>
								<tr>
									<td class="event">
										<?php fillIn(1, 18, 2027); ?>
									</td>
								</tr>
							</table>
						</td>
