...
<title>October, 2026 Hash Events</title>
...
<?php
    ...
    $prev_link="$09-2026.php";
    $next_link="$11-2026.php";
    include 'php.php';
?>
</head>
<body>
<map name="Map" id="Map">
    <area shape="rect" coords="0,0,150,91" href="$09-2026.php" alt="Previous Month" />
    <!-- FIXED: Using coordinates 957,0,807,91 as requested for the Next Month button -->
    <area shape="rect" coords="957,0,807,91" href="$11-2026.php" alt="Next Month" />
</map>
<div class=container>
					...
					<tr>
						...
						<td class="day">
							<table class="inner" id="j912">
								<tr>
									<td class="holiday"><span class="tag">Columbus Day</span>12</td>
								</tr>
								<tr>
									<td class="event">
										<?php fillIn(10, 12, 2026); ?>
									</td>
								</tr>
							</table>
						</td>
