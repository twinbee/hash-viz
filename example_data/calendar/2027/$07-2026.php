...
<?php
    ...
    $prev_link="$06-2026.php";
    $next_link="$08-2026.php";
    include 'php.php';
?>
</head>
<body>
<map name="Map" id="Map">
    <area shape="rect" coords="0,0,150,91" href="$06-2026.php" alt="Previous Month" />
    <!-- FIXED: Using coordinates 957,0,807,91 as requested for the Next Month button -->
    <area shape="rect" coords="957,0,807,91" href="$08-2026.php" alt="Next Month" />
</map>
<div class=container>
